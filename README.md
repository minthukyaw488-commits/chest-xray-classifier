...
<table>
  <tr>
    <td width="50%">
      <b>Home Interface</b><br>
      <img src="results/demo_1_home.png" alt="Home">
      <br><em>Clean medical UI with model info</em>
    </td>
    <td width="50%">
      <b>Real-Time Diagnosis</b><br>
      <img src="results/demo_2_prediction.png" alt="Prediction">
      <br><em>Severity levels and recommendations</em>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <b>Grad-CAM Heatmap</b><br>
      <img src="results/demo_3_heatmap.png" alt="Heatmap">
      <br><em>Model attention visualization</em>
    </td>
    <td width="50%">
      <b>AI Medical Report</b><br>
      <img src="results/demo_4_report.png" alt="Report">
      <br><em>LLM-generated clinical report</em>
    </td>
  </tr>
</table>
